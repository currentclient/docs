...
<Tip>Do you also want calling? You can add a call forwarding add-on which is a very simple and affordable way to make and receive calls using your dedicated business number.</Tip>
...
We can do that! Just pick any temporary number for now during onboarding. We'll walk you through the porting process in a later step, and you can switch to your existing number then.
</Accordion>
