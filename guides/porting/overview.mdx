...
<Tip>
  Want to learn more about text-only porting? [Check out our SMS hosting guide](/guides/porting/sms-hosting).
</Tip>
...
<Card
  ...
  icon="arrow-pointer"
  href="https://app.currentclient.com/app/settings/port-number"
  arrow="true"
