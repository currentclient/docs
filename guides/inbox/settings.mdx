...
description: "More about how inbox settings work and what you need to configure for each line"
---

## What is an inbox?

An inbox is simply a phone number.

And here's something important to know: **each phone number in CurrentClient is like its own independent unit**. This means that settings you configure for one phone number don't automatically apply to your other numbers.
...
>
  Mangage my inboxes and update inbox settings
</Card>
...
### TCPA compliance message

We can handle the TCPA compliance message for you. You should review this message to match your style and tone.

See our [tcpa compliance guide](/guides/inbox/tcpa-compliance) for more about how this works.
...
<Step title="Fine tune compliance message">
  Configure the tcpa compliance message to match your tone and style
</Step>
