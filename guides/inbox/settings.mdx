...
Here's something important to know: **each phone number in CurrentClient is like its own independent unit**. We call a phone number an inbox. This means that settings you configure for one phone number don't automatically apply to your other numbers.
